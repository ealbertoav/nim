...
class Nim:
    ...
    def available_actions(cls, piles):
        ...
        from a pile `i` (where piles are 0-indexed).
        """
        actions = set()
...
class NimAI:
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # If epsilon is True, with probability self.epsilon choose random action
...
def train(n):
    ...
    for i in range(n):
        ...
        # Keep track of the last move made by either player
        last = {
        ...
        while True:
            ...
            # Keep track of the last state and action
...
def play(ai, human_player=None):
    ...
    `human_player` can be set to 0 or 1 to specify whether
     a human player moves first or second.
    """
